...
body {
  ...
  .intro {
    ...
    width: 100%;
    height: 520px;
    background: linear-gradient(to bottom, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.5) 100%), url("https://www.grupoacasa.com.br/wp-content/uploads/2020/01/felicidade-para-idosos-longevidade.jpg");
...
<main>
  <div class="intro">
    <h1>O Seu Vizinho</h1>
    <p>Bem vindo(a) ao Seu Vizinho!</p>
    <button>Saiba mais!</button>
  </div>
  <div class="achievements">
    <div class="work">
      <i class="fas fa-users "></i>
      <p class="work-heading">Quem somos?</p>
      <p class="work-text">texto</p>
    </div>
    <div class="work">
      <i class="fas fa-fist-raised"></i>
      <p class="work-heading">O nosso objetivo</p>
      <p class="work-text">texto</p>
    </div>
    <div class="work">
